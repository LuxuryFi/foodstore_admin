  ...
  return (
    <div className='flex-1 overflow-auto relative z-10'>
      ...
      <main className='max-w-7x1 mx-auto py-6 px-4 lg:px-8 xl:px-20'>
        ...
        >
          <StatCard name='New User' icon={Users} value={13123} color='#6366F1'></StatCard>
          <StatCard name='Total users' icon={StickyNote} value={13123} color='#6366F1'></StatCard>
